	...
	private void menuButtonInit() {
		...
		menuShareButton.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
			    ...
			    intent.putExtra(Intent.EXTRA_SUBJECT, R.string.one_click_share_song_story);
			    //intent.putExtra(Intent.EXTRA_TEXT, "The status update text");
			    intent.putExtra(Intent.EXTRA_TEXT, getResources().getString(R.string.share_content));
			    startActivity(Intent.createChooser(intent, getResources().getString(R.string.one_click_share_song_story)));
			}
		});

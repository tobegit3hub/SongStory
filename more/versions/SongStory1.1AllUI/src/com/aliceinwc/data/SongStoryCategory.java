...
public class SongStoryCategory {
	...
	public SongStoryCategory(Context context, int number){
		...
		title = context.getResources().getStringArray(R.array.story_list_category_title)[number];
		titleSpecification = context.getResources().getStringArray(R.array.story_list_category_title_specification)[number];

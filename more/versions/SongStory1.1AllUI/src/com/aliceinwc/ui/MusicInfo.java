...
public class MusicInfo {
	...
	public MusicInfo(Activity actitity,String filepath) {
		this.activity = actitity;
		currentCursor = getCursorfromPath(filepath);	
...
//			int duration =  currentCursor.getInt(currentCursor
//					.getColumnIndexOrThrow(AudioColumns.DURATION));
//			return duration;

		    return Integer.parseInt(metaRetriever.extractMetadata(MediaMetadataRetriever.METADATA_KEY_DURATION));
	...
	public Bitmap getMusicAlbum() {
		long id = currentCursor.getLong(currentCursor
				.getColumnIndexOrThrow(BaseColumns._ID));
		long albumId = currentCursor.getLong(currentCursor
				.getColumnIndexOrThrow(AudioColumns.ALBUM_ID));

		return getArtwork(activity, id, albumId, true);
	}
	...
	private static Bitmap getDefaultArtwork(Context context) {
		...
		return BitmapFactory.decodeStream(context.getResources()
				.openRawResource(R.drawable.song_story_icon), null, opts);
	}

...
public class StoryListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			TextView songNameView = (TextView)convertView.findViewById(R.id.story_list_item_song_name);
			TextView singerNameView = (TextView)convertView.findViewById(R.id.story_list_item_singer_name);
			TextView songInformationView = (TextView)convertView.findViewById(R.id.story_list_item_song_information);
			ImageView songImageView = (ImageView)convertView.findViewById(R.id.story_list_item_song_image);
			...
			songImageView.setImageBitmap(BitmapFactory.decodeFile("sdcard/SongStory/image/"+stories.get(position).storyImageName2));

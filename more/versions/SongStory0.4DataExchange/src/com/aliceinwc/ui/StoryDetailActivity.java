...
public class StoryDetailActivity extends Activity {
	...
	private TextView mNewStoryTitle1;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//path = Environment.getExternalStorageDirectory().getPath()+"/SongStory/101.mp3";
	...
	private void textInit() {
		...
		//mLyric = new Lyric(new File("sdcard/101.lrc"));
		...
		mNewStoryTitle1 = (TextView) findViewById(R.id.new_first_title);
		...
		mNewStoryTitle1.setText(songStory.storyTitle1);
		mFirstInfo.setText(songStory.storyContent1);
		mNewStoryTitle1.setText(songStory.storyTitle1);
		mStoryTitle2.setText(songStory.stroyTitle2);
	...
	private void menuButtonInit() {
		...
		menuShareButton.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
			    ...
			    intent.putExtra(Intent.EXTRA_TEXT, songStory.storyContent1);

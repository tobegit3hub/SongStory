...
//        }
	...
	public static String requestSsUrl(int category_number, int story_number){
		...
		String url = NetworkUtil.BASE_URL+"/SongStoryServer/response.php?category_number="+category_number+"&song_number="+story_number;
		
		try {
			String responseString = NetworkUtil.httpGetRequest(url);

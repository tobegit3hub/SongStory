...
public class FileUtil {
	...
	public static ArrayList<SongStory> readJsonFilesAndDelete() {
		...
		if (Environment.getExternalStorageState().equals(
			...
			String jsonPath = Environment.getExternalStorageDirectory()
					.getPath() + "/SongStory/json/";
			File jsonDirectory = new File(jsonPath);

			for (String jsonFileName : jsonDirectory
					.list(new ExtentionFilenameFilter("json"))) {
